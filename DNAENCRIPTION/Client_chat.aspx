<%@ Page Title="" Language="C#" MasterPageFile="~/client.Master" AutoEventWireup="true" CodeBehind="Client_chat.aspx.cs" Inherits="DNAENCRIPTION.WebForm16" %>
             ...
             <asp:View ID="View2" runat="server">
                  <div class="card"  style="color:white;height:100%">
                                <div class="card-header">
                                    <h3>Employee Chat</h3>
                                    <br />
                                    <asp:DropDownList ID="chat2" CssClass="form-control" runat="server" OnSelectedIndexChanged="chat1_SelectedIndexChanged" AppendDataBoundItems="True" AutoPostBack="True">

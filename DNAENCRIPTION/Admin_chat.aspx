<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Admin_chat.aspx.cs" Inherits="DNAENCRIPTION.WebForm11" %>
            ...
            <div class="head">
                                <div class="row">
                                   &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <div class="col-xs-6">
                                        ...
                                        <asp:LinkButton ID="LinkButton1" CssClass=" voter-form-link" runat="server" OnClick="LinkButton1_Click" CausesValidation="False" ForeColor="White">Employee</asp:LinkButton>
                                    </div>&nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
                                    <div class="col-xs-6">
                                        <asp:LinkButton ID="LinkButton2" CssClass="candidate-form-link" runat="server" OnClick="LinkButton2_Click" CausesValidation="False" ForeColor="White">User</asp:LinkButton>
                                    </div>
                                </div>
                                </div>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
            <div class="card"  style="color:white;">
                                ...
                                <div class="card-body" style="padding-top:0px;padding-left:150px;padding-right:100px">
                                  ...
                                  <asp:Panel ID="Panel1" runat="server" Visible="false" BackColor="#5ba388" Height="270px" ScrollBars="Vertical" Width="400px" BorderStyle="Outset" Direction="LeftToRight">
                                    ...
                                    <asp:DataList ID="DataList1" runat="server">
                                        <ItemTemplate>
                                            <div class="row" >
                                                <div class="col-xl-4">
                                            <asp:Label ID="mm" runat="server" Text='<%# Eval("name") %>' ForeColor="White"></asp:Label>
                                            &nbsp;
                                                </div>
                                                <div class="col-xl-8">
        ...
        <asp:View ID="View2" runat="server">
            <div class="card"  style="color:white; ">
                                <div class="card-header">
                                    <h3>Client Chat</h3>
                                    <br />
                                    <asp:DropDownList ID="chat2" CssClass="form-control" runat="server" OnSelectedIndexChanged="chat2_SelectedIndexChanged" AppendDataBoundItems="True" AutoPostBack="True">
               ...
               <asp:Panel ID="Panel3" runat="server" Visible="false" BackColor="#5ba388" Height="270px" ScrollBars="Vertical" Width="400px" BorderStyle="Outset" Direction="LeftToRight">
                                    ...
                                    <asp:DataList ID="DataList2" runat="server">
                                        <ItemTemplate>
                                            ...
                                            &nbsp;
                                                ...
                                                <div class="col-xl-8">
                                                    <div class="ch" style=" display: inline-block;color: Black;background-color: #dfece7;height: 45px; width: 240px;padding: 12px;border-radius: 25px;">
                                              <asp:Label ID="Label2" runat="server" Text='<%# Eval("message") %>' BackColor="Transparent"></asp:Label>
</div>                                                </div>
                                            </div>
                                            &nbsp;&nbsp;
                                    ...
                                    <asp:TextBox ID="TextBox2" TextMode="MultiLine" BackColor="#dfece7"  CssClass="form-control"  runat="server" ></asp:TextBox>
                                     ...
                                     <div class="form-group" style="left: -1px; top: 0px; width: 400px">
                                            <asp:Button ID="Button2" class="btn float-right login_btn" runat="server" Text="Send" OnClick="Button2_Click" />
                                    </div>
                                          </asp:Panel>
                                            </ContentTemplate>
                    </asp:UpdatePanel>
